...
while True:
    try:
        ...
        while t < 16:
            ...
            print(
                f"Checking block {pb} to {cb} ({str(int(cb)-int(pb))}) - Txs to check: {t}",
                end="\r",
            )
            """
            ...
            try:
                ...
                if dolla >= 100:
                    ...
                    if hw.count("Binance: Hot Wallet") == 0:
                        ...
                        hw.count("Binance: Hot Wallet") == 2
                        and hw.find("Binance: Hot Wallet 6") != -1
                        ...
                        dstg = (
                            ...
                            + "\n"
                            + e
                            + "\nBinance Hot Wallet Token Transfer of "
                            + token_name
                            + " "
                            + testo
                        )
        ...
        print(
            "You got momentarily blocked by bscscan.com, will try again in 15 seconds"
        )
        time.sleep(15)
